...
/// [Navigator.pop].
///
/// Use [showIntervalTimePicker] to show a dialog already containing a [IntervalTimePickerDialog].
class IntervalTimePickerDialog extends StatefulWidget {
  ...
  /// The default is VisibleStep.fifths (every 5 minutes).
...
class _IntervalTimePicker extends StatefulWidget {
  /// Creates a const Material Design time picker.
  const _IntervalTimePicker({
    required this.time,
  ...
  @override
  State<_IntervalTimePicker> createState() => _IntervalTimePickerState();
}

class _IntervalTimePickerState extends State<_IntervalTimePicker>
    with RestorationMixin {
  Timer? _vibrateTimer;
  late MaterialLocalizations localizations;
  ...
  @override
  void didUpdateWidget(_IntervalTimePicker oldWidget) {
    super.didUpdateWidget(oldWidget);
